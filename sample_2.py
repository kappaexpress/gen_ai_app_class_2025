...
generate_content_config = types.GenerateContentConfig(
    # temperature: 生成の創造性・ランダム性を制御（範囲: 0.0-2.0）
    # 0に近いほど決定的で一貫性のある出力、2に近いほど創造的でランダムな出力
    temperature=1.0,
    # top_p: samplingのパラメータ（範囲: 0.0-1.0）
    # 確率の累積が top_p に達するまでのトークンのみを候補として選択
    # 1.0はすべてのトークンを候補とする
    # 低い値にすると、より確実性の高い出力になる
    top_p=1.0,
)
